...
func generatorTmplSqlmgrTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "generator/tmpl/sqlmgr.tmpl", size: 6970, mode: os.FileMode(420), modTime: time.Unix(1488887631, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
