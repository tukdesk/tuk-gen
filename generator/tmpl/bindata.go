...
func generatorTmplSql_script_tableTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "generator/tmpl/sql_script_table.tmpl", size: 428, mode: os.FileMode(420), modTime: time.Unix(1488781225, 0)}
...
func generatorTmplSqlmgrTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "generator/tmpl/sqlmgr.tmpl", size: 6932, mode: os.FileMode(420), modTime: time.Unix(1488781221, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func generatorTmplStructTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "generator/tmpl/struct.tmpl", size: 4261, mode: os.FileMode(420), modTime: time.Unix(1488781221, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
